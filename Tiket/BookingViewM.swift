    ...
    var body: some View {
        ScrollView {
            VStack(spacing: 24) {
                ...
                NavigationLink(destination: PaymentViewM(movie: movie, date: selectedDate, time: selectedTime, seats: selectedSeats)) {
                ...
                NavigationLink(destination: PaymentViewM(movie: movie, date: selectedDate, time: selectedTime, seats: [])) {
